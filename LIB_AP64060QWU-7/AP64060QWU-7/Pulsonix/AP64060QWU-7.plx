...
//17046331/1072894/2.50/6/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AP64060QWU-7" (originalName "AP64060QWU-7")
	...
	(compDef "AP64060QWU-7" (originalName "AP64060QWU-7") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP64060QWU-7"))
		...
		(attr "Mouser Part Number" "621-AP64060QWU-7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AP64060QWU-7?qs=Li%252BoUPsLEnvtPycFvZmEcQ%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "AP64060QWU-7")
		(attr "Description" "Switching Voltage Regulators DCDC Conv HV Buck TSOT26(STD) T&R 3K")
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/AP64060.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "AP64060QWU-7.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=0.53")
